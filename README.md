...
Our team really appreciates collaboration, not only because it boosts the `vlingo` components evolution but also for that simple fact: more people, more different standpoints, more complete and mature `vlingo` community will be. If you are looking forward to it, take a tour in our development guide. 
