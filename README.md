...
Extract the file content, then set an environment variable named `VLINGO_XOOM_STARTER_HOME` indicating the absolute path for the uncompressed folder. Consider an example:

```
# Mac OS/X or Linux
$ VLINGO_XOOM_STARTER_HOME=/Users/awesomedev/tools/vlingo-xoom-starter/dist/starter
$ export VLINGO_XOOM_STARTER_HOME
$ 
```

```
# Windows, but prefer: System Properties > Environment Variables > User variables for awesomedev
C:\Users\awesomedev> set VLINGO_XOOM_STARTER_HOME=C:\Users\awesomedev\tools\vlingo-xoom-starter\dist\starter
C:\Users\awesomedev> 
```
