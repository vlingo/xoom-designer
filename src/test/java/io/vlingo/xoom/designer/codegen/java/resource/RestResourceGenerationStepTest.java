...
public class RestResourceGenerationStepTest extends CodeGenerationTest {
  ...
  public void testThatRestResourceWIthComplexURIIsGenerated() {
    ...
    final CodeGenerationParameters parameters = CodeGenerationParameters.from(packageParameter, dialect,
        useCQRSParameter,
        authorAggregateWithComplexURI(), nameValueObject(), rankValueObject(),
        classificationValueObject(), classifierValueObject());
    ...
    Assertions.assertEquals(11, context.contents().size());
    Assertions.assertTrue(authorResource.contains(TextExpectation.onJava().read("author-rest-resource-with-complex-uri")));
  }
  ...
  public void testRestResourceGenerationOnKotlin() {
    ...
    final CodeGenerationParameter languageParameter = CodeGenerationParameter.of(Label.DIALECT, Dialect.KOTLIN);

    final CodeGenerationParameters parameters = CodeGenerationParameters.from(packageParameter,
    ...
    Assertions.assertTrue(authorResource.contains(
        "return stage().actorOf(Author::class.java, stage().addressFactory().from(id), Definition.has(AuthorEntity::class.java, Definition.parameters(id)))"));
  }


  private CodeGenerationParameter authorAggregateWithComplexURI() {
    ...
    final CodeGenerationParameter withNameRoute = CodeGenerationParameter.of(Label.ROUTE_SIGNATURE, "withName")
        ...
        .relate(Label.ROUTE_PATH, "/catalogs/{catalogId}/authors")
    ...
    final CodeGenerationParameter changeRankRoute = CodeGenerationParameter.of(Label.ROUTE_SIGNATURE, "changeRank")
        ...
        .relate(Label.ROUTE_PATH, "/catalogs/{catalogId}/authors/{id}/rank")
    ...
    final CodeGenerationParameter addTagRoute = CodeGenerationParameter.of(Label.ROUTE_SIGNATURE, "addTag")
        .relate(Label.ROUTE_METHOD, "PATCH")
        .relate(Label.ROUTE_PATH, "/catalogs/{catalogId}/authors/{id}/tag")
        .relate(Label.REQUIRE_ENTITY_LOADING, "true");

    final CodeGenerationParameter addTagsRoute = CodeGenerationParameter.of(Label.ROUTE_SIGNATURE, "addTags")
        .relate(Label.ROUTE_METHOD, "PATCH")
        .relate(Label.ROUTE_PATH, "/catalogs/{catalogId}/authors/{id}/tags")
        .relate(Label.REQUIRE_ENTITY_LOADING, "true");
    ...
    final CodeGenerationParameter relatedAuthorRoute = CodeGenerationParameter.of(Label.ROUTE_SIGNATURE, "relateAuthor")
        .relate(Label.ROUTE_METHOD, "PATCH")
        .relate(Label.ROUTE_PATH, "/catalogs/{catalogId}/authors/{id}/related-author")
        .relate(Label.REQUIRE_ENTITY_LOADING, "true");

    final CodeGenerationParameter relatedAuthorsRoute = CodeGenerationParameter
        .of(Label.ROUTE_SIGNATURE, "relateAuthors")
        .relate(Label.ROUTE_METHOD, "PATCH")
        .relate(Label.ROUTE_PATH, "/catalogs/{catalogId}/authors/{id}/related-authors")
        .relate(Label.REQUIRE_ENTITY_LOADING, "true");
    ...
    final CodeGenerationParameter unavailableRoute = CodeGenerationParameter
        ...
        .relate(Label.ROUTE_METHOD, "PATCH")
        .relate(Label.ROUTE_PATH, "/catalogs/{catalogId}/authors/{id}/status")
        .relate(Label.REQUIRE_ENTITY_LOADING, "true");

    return CodeGenerationParameter.of(Label.AGGREGATE, "Author")
        .relate(Label.URI_ROOT, "/catalogs/{catalogId}/authors").relate(idField)
  ...
  private Content[] contents() {
    return new Content[] {
        Content.with(JavaTemplateStandard.AGGREGATE_PROTOCOL,
            new OutputFile(Paths.get(MODEL_PACKAGE_PATH, "author").toString(), "Author.java"), null, null,
            AUTHOR_CONTENT_TEXT),
        Content.with(JavaTemplateStandard.AGGREGATE,
            new OutputFile(Paths.get(MODEL_PACKAGE_PATH, "author").toString(), "AuthorEntity.java"), null, null,
            AUTHOR_AGGREGATE_CONTENT_TEXT),
        Content.with(JavaTemplateStandard.AGGREGATE_STATE,
            new OutputFile(Paths.get(MODEL_PACKAGE_PATH, "author").toString(), "AuthorState.java"), null, null,
            AUTHOR_STATE_CONTENT_TEXT),
        Content.with(JavaTemplateStandard.VALUE_OBJECT,
            new OutputFile(Paths.get(MODEL_PACKAGE_PATH).toString(), "Rank.java"), null, null,
        ...
        Content.with(JavaTemplateStandard.VALUE_OBJECT,
            new OutputFile(Paths.get(MODEL_PACKAGE_PATH).toString(), "Tag.java"), null, null,
            TAG_VALUE_OBJECT_CONTENT_TEXT),
        Content.with(JavaTemplateStandard.DATA_OBJECT,
            new OutputFile(Paths.get(INFRASTRUCTURE_PACKAGE_PATH).toString(), "AuthorData.java"), null, null,
            AUTHOR_DATA_CONTENT_TEXT),
        Content.with(JavaTemplateStandard.QUERIES,
            new OutputFile(Paths.get(PERSISTENCE_PACKAGE_PATH).toString(), "AuthorQueries.java"), null, null,
            AUTHOR_QUERIES_CONTENT_TEXT),
        Content.with(JavaTemplateStandard.QUERIES_ACTOR,
            new OutputFile(Paths.get(PERSISTENCE_PACKAGE_PATH).toString(), "AuthorQueriesActor.java"), null, null,
  ...
  private static final String AUTHOR_CONTENT_TEXT = "package io.vlingo.xoomapp.model.author; \\n" +
      "public interface Author { \\n" +
      "... \\n" +
      "}";

  private static final String AUTHOR_STATE_CONTENT_TEXT = "package io.vlingo.xoomapp.model.author; \\n" +
      "public class AuthorState { \\n" +
      "... \\n" +
      "}";

  private static final String AUTHOR_AGGREGATE_CONTENT_TEXT = "package io.vlingo.xoomapp.model.author; \\n" +
      "public class AuthorEntity { \\n" +
      "... \\n" +
      "}";

  private static final String AUTHOR_DATA_CONTENT_TEXT = "package io.vlingo.xoomapp.infrastructure; \\n" +
  ...
  private static final String RANK_VALUE_OBJECT_CONTENT_TEXT = "package io.vlingo.xoomapp.model; \\n" +
      "public class Rank { \\n" +
      "... \\n" +
      "}";

  private static final String TAG_VALUE_OBJECT_CONTENT_TEXT = "package io.vlingo.xoomapp.model; \\n" +
      "public class Tag { \\n" +
      "... \\n" +
      "}";

  private static final String AUTHOR_QUERIES_CONTENT_TEXT = "package io.vlingo.xoomapp.infrastructure.persistence; \\n"
      +
      "public interface AuthorQueries { \\n" +
      "... \\n" +
      "}";

  private static final String AUTHOR_QUERIES_ACTOR_CONTENT_TEXT = "package io.vlingo.xoomapp.infrastructure.persistence; \\n"
      +
