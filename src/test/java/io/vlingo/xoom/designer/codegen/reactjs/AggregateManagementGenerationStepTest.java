...
public class AggregateManagementGenerationStepTest {
  ...
  public void testThatAggregateManagementIsGenerated() {
    ...
    final Content aggregateList = context.findContent(ReactJsTemplateStandard.AGGREGATE_LIST, "Authors");
    final Content withNameMethod = context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "AuthorWithName");
    final Content changeRankMethod = context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "AuthorChangeRank");
    final Content aggregateDetail = context.findContent(ReactJsTemplateStandard.AGGREGATE_DETAIL, "Author");
  ...
  public void testThatAggregateWithPrimitiveCollectionIsGenerated() {
    ...
    final Content aggregateList = context.findContent(ReactJsTemplateStandard.AGGREGATE_LIST, "Users");
    final Content withNameMethod = context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "UserWithName");
    final Content aggregateDetail = context.findContent(ReactJsTemplateStandard.AGGREGATE_DETAIL, "User");
  ...
  public void testThatAggregateWithValueObjectCollectionIsGenerated() {
    ...
    final Content aggregateList = context.findContent(ReactJsTemplateStandard.AGGREGATE_LIST, "Catalogs");
    final Content createMethod = context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "CatalogCreate");
    final Content addItemMethod = context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "CatalogAddItem");
    final Content aggregateDetail = context.findContent(ReactJsTemplateStandard.AGGREGATE_DETAIL, "Catalog");
  ...
  public void testThatAggregateWithValueObjectCollectionOnFactoryMethodIsGenerated() {
    ...
    final Content aggregateList = context.findContent(ReactJsTemplateStandard.AGGREGATE_LIST, "Orders");
    final Content createMethod = context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "OrderCreate");
    final Content aggregateDetail = context.findContent(ReactJsTemplateStandard.AGGREGATE_DETAIL, "Order");
  ...
  public void testThatAggregateWithTwoLevelCollectionIsGenerated() {
    ...
    final Content aggregateList = context.findContent(ReactJsTemplateStandard.AGGREGATE_LIST, "Proposals");
    final Content submitForMethod = context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "ProposalSubmitFor");
    final Content aggregateDetail = context.findContent(ReactJsTemplateStandard.AGGREGATE_DETAIL, "Proposal");
  ...
  public void testThatAggregateMethodWithoutApiModelIsNotGenerated() {
    ...
    Assertions.assertThrows(IllegalArgumentException.class, () -> context.findContent(ReactJsTemplateStandard.AGGREGATE_METHOD, "AuthorChangeRank"));
    Assertions.assertTrue(aggregateList.contains(TextExpectation.onReactJs().read("author-aggregate-list")));
    Assertions.assertTrue(withNameMethod.contains(TextExpectation.onReactJs().read("author-with-name-method")));
  ...
  private CodeGenerationParameter orderAggregateWithCommandParametersAndCollections() {
    ...
    final CodeGenerationParameter factoryMethod =
        CodeGenerationParameter.of(Label.AGGREGATE_METHOD, "create")
            .relate(CodeGenerationParameter.of(Label.METHOD_PARAMETER, "clientName"))
            .relate(CodeGenerationParameter.of(Label.METHOD_PARAMETER, "clientAddress"))
            .relate(CodeGenerationParameter.of(Label.METHOD_PARAMETER, "orderLines")
  ...
  private CodeGenerationParameter catalogAggregate() {
    ...
    final CodeGenerationParameter addItemMethod =
        CodeGenerationParameter.of(Label.AGGREGATE_METHOD, "addItem")
            .relate(CodeGenerationParameter.of(Label.METHOD_PARAMETER, "items")
