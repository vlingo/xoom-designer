...
public class LayoutGenerationStepTest {
  ...
  public void testThatLayoutIsGenerated() {
    ...
    final Content app = context.findContent(ReactJsTemplateStandard.APP, "App");
    final Content sidebar = context.findContent(ReactJsTemplateStandard.SIDEBAR, "Sidebar");
    final Content header = context.findContent(ReactJsTemplateStandard.HEADER, "Header");
