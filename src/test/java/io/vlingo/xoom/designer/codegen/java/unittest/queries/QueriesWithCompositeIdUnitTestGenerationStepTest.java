...
public class QueriesWithCompositeIdUnitTestGenerationStepTest extends CodeGenerationTest {
  ...
  public void testThatQueriesUnitTestAreGenerated() {
    ...
    Assertions.assertTrue(bookQueriesTest.contains(TextExpectation.onJava().read("book-queries-with-composite-id-unit-test")));
  }
