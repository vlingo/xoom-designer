...
public class EntityWithCompositeIdUnitTestGenerationStepTest extends CodeGenerationTest {
  ...
  public void testThatSourcedEntitiesUnitTestsAreGenerated() {
    ...
    Assertions.assertTrue(bookEntityTest.contains(TextExpectation.onJava().read("sourced-book-entity-with-composite-id-test")));
  ...
  public void testThatStatefulEntitiesWithEventBasedProjectionUnitTestsAreGenerated() {
    ...
    Assertions.assertTrue(bookEntityTest.contains(TextExpectation.onJava().read("stateful-book-entity-with-composite-id-test-with-event-based-projection")));
    Assertions.assertTrue(mockDispatcher.contains(TextExpectation.onJava().read("event-based-mock-dispatcher")));
  }
  ...
  public void testThatStatefulEntitiesWithOperationBasedProjectionUnitTestsAreGenerated() {
    ...
    Assertions.assertTrue(bookEntityTest.contains(TextExpectation.onJava().read("stateful-book-entity-with-composite-id-test-with-operation-based-projection")));
  ...
  private CodeGenerationParameter bookAggregate() {
    final CodeGenerationParameter bookCatalogedEvent =
            CodeGenerationParameter.of(Label.DOMAIN_EVENT, "BookCataloged")
                .relate(CodeGenerationParameter.of(Label.STATE_FIELD, "authorId"))
    ...
    return CodeGenerationParameter.of(Label.AGGREGATE, "Book")
        ...
        .relate(authorIdField).relate(nameField).relate(rankField).relate(groupField);
  }
