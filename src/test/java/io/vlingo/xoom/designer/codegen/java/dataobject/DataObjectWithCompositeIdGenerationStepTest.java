...
public class DataObjectWithCompositeIdGenerationStepTest extends CodeGenerationTest {
  ...
  public void testThatDataObjectsAreGenerated() {
    ...
    Assertions.assertTrue(bookDataContent.contains(TextExpectation.onJava().read("book-data-with-composite-id")));
