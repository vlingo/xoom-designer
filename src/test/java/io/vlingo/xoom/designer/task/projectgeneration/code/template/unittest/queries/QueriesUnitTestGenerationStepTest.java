...
public class QueriesUnitTestGenerationStepTest {
  ...
  public void testThatQueriesUnitTestAreGenerated() throws IOException {
    ...
    final Content authorQueriesTest =
            context.findContent(QUERIES_UNIT_TEST, "AuthorQueriesTest");

    final Content bookQueriesTest =
            context.findContent(QUERIES_UNIT_TEST, "BookQueriesTest");
  ...
  private Content[] contents() {
    return new Content[] {
            ...
            Content.with(DATA_OBJECT, new OutputFile(Paths.get(PERSISTENCE_PACKAGE_PATH).toString(), "AuthorData.java"), null, null, AUTHOR_DATA_CONTENT_TEXT),
            Content.with(DATA_OBJECT, new OutputFile(Paths.get(PERSISTENCE_PACKAGE_PATH).toString(), "BookData.java"), null, null, BOOK_DATA_CONTENT_TEXT),
    };
  }
