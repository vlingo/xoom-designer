...
public class StorageTemplateDataFactoryTest {
    ...
    public void testStorageTemplateDataOnSourcedSingleModel() {
        ...
        Assertions.assertEquals(2, allTemplatesData.stream().filter(templateData -> templateData.hasStandard(ADAPTER)).count());
        ...
        Assertions.assertEquals(JOURNAL, stateAdapterConfigurationParameters.find(STORAGE_TYPE));
        Assertions.assertEquals(1, stateAdapterConfigurationParameters.<Set<ImportParameter>>find(IMPORTS).size());
        ...
        Assertions.assertEquals(DOMAIN, storeProviderParameters.find(MODEL));
        Assertions.assertEquals("JournalProvider", storeProviderParameters.find(STORE_PROVIDER_NAME));
        Assertions.assertEquals(4, storeProviderParameters.<Set<ImportParameter>>find(IMPORTS).size());
        ...
        Assertions.assertEquals("BookRented", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(0).getSourceClass());
        Assertions.assertEquals("BookRentedAdapter", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(0).getAdapterClass());
        Assertions.assertEquals("BookPurchased", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(1).getSourceClass());
        Assertions.assertEquals("BookPurchasedAdapter", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(1).getAdapterClass());
        Assertions.assertEquals(2, storeProviderParameters.<Set<String>>find(AGGREGATES).size());
        Assertions.assertTrue(storeProviderParameters.<Set<String>>find(AGGREGATES).contains("AuthorEntity"));
        Assertions.assertTrue(storeProviderParameters.<Set<String>>find(AGGREGATES).contains("BookEntity"));
    ...
    public void testStorageTemplateDataOnStatefulSingleModel() {
        ...
        Assertions.assertEquals(EXPECTED_PACKAGE, stateAdapterConfigurationParameters.find(PACKAGE_NAME));
        Assertions.assertEquals("BookState", stateAdapterConfigurationParameters.find(SOURCE_NAME));
        ...
        Assertions.assertEquals(2, storeProviderParameters.<Set<ImportParameter>>find(IMPORTS).size());
        ...
        Assertions.assertEquals("BookState", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(0).getSourceClass());
        Assertions.assertEquals("BookStateAdapter", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(0).getAdapterClass());
        Assertions.assertEquals("AuthorState", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(1).getSourceClass());
        Assertions.assertEquals("AuthorStateAdapter", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(1).getAdapterClass());
    ...
    public void testStorageTemplateDataOnStatefulCQRSModel() {
        ...
        Assertions.assertEquals(2, allTemplatesData.stream().filter(templateData -> templateData.hasStandard(ADAPTER)).count());
        Assertions.assertEquals(2, allTemplatesData.stream().filter(templateData -> templateData.hasStandard(STORE_PROVIDER)).count());
        ...
        IntStream.range(0, 1).forEach(modelClassificationIndex -> {
            ...
            Assertions.assertEquals(EXPECTED_PACKAGE, storeProviderParameters.find(PACKAGE_NAME));
            Assertions.assertEquals(model, storeProviderParameters.find(MODEL));
            Assertions.assertEquals(model.title + "StateStoreProvider", storeProviderParameters.find(STORE_PROVIDER_NAME));
            Assertions.assertEquals(expectedImports, storeProviderParameters.<Set<ImportParameter>>find(IMPORTS).size());
            Assertions.assertTrue(storeProviderParameters.hasImport("io.vlingo.xoomapp.model.author.AuthorState"));
            Assertions.assertTrue(storeProviderParameters.hasImport("io.vlingo.xoomapp.model.book.BookState"));
            Assertions.assertEquals("BookState", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(0).getSourceClass());
            Assertions.assertEquals("BookStateAdapter", storeProviderParameters.<List<Adapter>>find(ADAPTERS).get(0).getAdapterClass());
