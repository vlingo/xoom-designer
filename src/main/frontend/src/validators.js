...
export const classNameRule = (value) => /^[A-Z]+[A-Za-zÀ-ÖØ-öø-ÿ]*$/.test(value) ? undefined : errors.CLASSNAME;
export const identifierRule = (value) => /^[a-zA-Z_$][a-zA-ZÀ-ÖØ-öø-ÿ_$0-9]*$/.test(value) ? undefined : errors.FIELDNAME;
