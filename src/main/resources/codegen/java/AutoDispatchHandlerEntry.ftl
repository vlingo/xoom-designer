<#if factoryMethod && !requireEntityLoading>
    public static final HandlerEntry<${handlerType}
    <Completes<${stateName}>, Stage, ${compositeIdType}${dataName}>> ${indexName}_HANDLER =
...
<#else>
    public static final HandlerEntry<${handlerType}
    <Completes<${stateName}>, ${aggregateProtocolName}, ${compositeIdType}${dataName}>> ${indexName}_HANDLER =
