...
import static io.vlingo.xoom.designer.task.projectgeneration.code.java.TemplateParameter.QUERIES_ACTOR_NAME;
...
public class QueriesActorTemplateData extends TemplateData {
  ...
  protected QueriesActorTemplateData(final String aggregateProtocol,
    ...
    this.parameters =
            parameters.and(QUERIES_ACTOR_NAME, JavaTemplateStandard.QUERIES_ACTOR.resolveClassname(aggregateProtocol));
  }
