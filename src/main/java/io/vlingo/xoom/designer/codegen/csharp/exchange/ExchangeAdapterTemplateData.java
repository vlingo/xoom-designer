...
public class ExchangeAdapterTemplateData extends TemplateData {
  ...
  private ExchangeAdapterTemplateData(final String exchangePackage,
    ...
    this.parameters = TemplateParameters.with(TemplateParameter.PACKAGE_NAME, exchangePackage)
        ...
        .andResolve(TemplateParameter.EXCHANGE_ADAPTER_NAME, CsharpTemplateStandard.EXCHANGE_ADAPTER::resolveClassname)
        .andResolve(TemplateParameter.EXCHANGE_MAPPER_NAME, CsharpTemplateStandard.EXCHANGE_MAPPER::resolveClassname)
  ...
  public TemplateStandard standard() {
    return CsharpTemplateStandard.EXCHANGE_ADAPTER;
  }
