...
public class TestCase {
  ...
  private TestCase(final String testMethodName, final CodeGenerationParameter aggregate,
                   final List<CodeGenerationParameter> valueObjects) {
    ...
    this.dataDeclarations.addAll(StaticDataDeclaration.generate(methodName, aggregate, valueObjects, testDataValues));
