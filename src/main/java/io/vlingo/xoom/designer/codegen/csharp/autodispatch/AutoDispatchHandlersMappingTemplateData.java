...
import static io.vlingo.xoom.designer.codegen.csharp.CsharpTemplateStandard.QUERIES;
import static io.vlingo.xoom.designer.codegen.csharp.CsharpTemplateStandard.*;
...
public class AutoDispatchHandlersMappingTemplateData extends TemplateData {
  ...
  private final static String HANDLER_INDEX_PATTERN = "public static int %s = %d;";
  ...
  protected AutoDispatchHandlersMappingTemplateData(final String basePackage, final Dialect dialect,
  ...
  public TemplateStandard standard() {
    return CsharpTemplateStandard.AUTO_DISPATCH_HANDLERS_MAPPING;
  }
