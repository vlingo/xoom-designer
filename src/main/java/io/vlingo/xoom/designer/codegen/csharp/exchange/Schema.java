...
import static io.vlingo.xoom.designer.codegen.csharp.FieldDetail.isDateTime;
...
public class Schema {
  ...
  public Schema(final String schemaGroup, final CodeGenerationParameter publishedLanguage) {
