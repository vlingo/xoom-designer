...
public class AggregateMethodTemplateData extends TemplateData {
  ...
  public static List<TemplateData> from(final TemplateParameters parentParameters,
    ...
    return aggregate.retrieveAllRelated(Label.AGGREGATE_METHOD)
        .map(method -> new AggregateMethodTemplateData(parentParameters, method, storageType))
        .collect(toList());
  }
  ...
  private AggregateMethodTemplateData(final TemplateParameters parentParameters, final CodeGenerationParameter method,
    ...
    this.parameters = TemplateParameters.with(TemplateParameter.METHOD_NAME, AggregateDetail.methodNameFrom(method))
        ...
        .and(io.vlingo.xoom.designer.codegen.java.TemplateParameter.DOMAIN_EVENT_CONSTRUCTOR_PARAMETERS, Formatters.Arguments.DOMAIN_EVENT_CONSTRUCTOR_INVOCATION.format(method))
