...
import io.vlingo.xoom.designer.codegen.csharp.model.valueobject.ValueObjectTemplateData;
...
public class ValueObjectGenerationStep extends TemplateProcessingStep {
  ...
  public boolean shouldProcess(final CodeGenerationContext context) {
    ...
    return !dialectName.isEmpty() && Dialect.withName(dialectName).equals(Dialect.C_SHARP) && context.hasParameter(Label.VALUE_OBJECT);
  }
